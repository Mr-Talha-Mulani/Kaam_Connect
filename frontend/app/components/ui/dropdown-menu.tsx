    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "z-50 min-w-32 overflow-hidden rounded-md border border-[var(--border)] p-1 shadow-md",
          className
        )}
        {...props}
      />
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-[var(--kaam-light-blue)] focus:text-[var(--primary)]",
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-[var(--kaam-light-blue)] data-[state=open]:bg-[var(--kaam-light-blue)]",
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        ...
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        "z-50 min-w-32 overflow-hidden rounded-md border border-[var(--border)] p-1 shadow-lg",
        className
      )}
      {...props}
    />
